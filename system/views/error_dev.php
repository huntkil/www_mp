...
<head>
    ...
    <title>Error - My Playground</title>
    <style>
        body {
    ...
    <div class="error-container">
        ...
        <div class="error-content">
            <div class="error-detail">
                <h3>Error Details</h3>
                <p><strong>Message:</strong> <?php echo htmlspecialchars($error['message'] ?? 'Unknown error'); ?></p>
                ...
                <?php if (isset($error['level'])): ?>
                    <p><strong>Level:</strong> <?php echo htmlspecialchars($error['level']); ?></p>
                <?php endif; ?>

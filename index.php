...
<div class="container mx-auto px-4 py-8">
    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Card Slideshow -->
            <a href="<?php echo $nav->getModuleUrl('learning/card/slideshow.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
            ...
            <!-- Word Cards EN -->
            <a href="<?php echo $nav->getModuleUrl('learning/card/wordcard_en.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
            ...
            <!-- Word Cards KR -->
            <a href="<?php echo $nav->getModuleUrl('learning/card/wordcard_ko.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
            ...
            <!-- Vocabulary -->
            <a href="<?php echo $nav->getModuleUrl('learning/voca/voca.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <!-- News Search -->
            <a href="<?php echo $nav->getModuleUrl('tools/news/search_news_form.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-10 h-10 bg-blue-500/10 rounded-lg flex items-center justify-center group-hover:bg-blue-500/20 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" class="text-blue-500">
            ...
            <!-- Family Tour -->
            <a href="<?php echo $nav->getModuleUrl('tools/tour/familytour.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-10 h-10 bg-green-500/10 rounded-lg flex items-center justify-center group-hover:bg-green-500/20 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" class="text-green-500">
            ...
            <!-- Box Breathing -->
            <a href="<?php echo $nav->getModuleUrl('tools/box/boxbreathe.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-10 h-10 bg-purple-500/10 rounded-lg flex items-center justify-center group-hover:bg-purple-500/20 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" class="text-purple-500">
    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <!-- CRUD Demo -->
            <a href="<?php echo $nav->getModuleUrl('management/crud/data_list.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-10 h-10 bg-blue-500/10 rounded-lg flex items-center justify-center group-hover:bg-blue-500/20 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" class="text-blue-500">
            ...
            <!-- My Health -->
            <a href="<?php echo $nav->getModuleUrl('management/myhealth/health_list.php'); ?>" class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-10 h-10 bg-green-500/10 rounded-lg flex items-center justify-center group-hover:bg-green-500/20 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" class="text-green-500">

...
try {
    ...
    $category = isset($input['category']) ? trim($input['category']) : '일반';
    $difficulty = isset($input['difficulty']) ? trim($input['difficulty']) : '초급';
    ...
    // 문장 추가
    $newSentence = $manager->addSentence($text, $category, $difficulty);
